...
public class ObjectiveAssessment extends Assessment{
    ...
    private String type = "Objective Assessment";

    public ObjectiveAssessment(int assessmentID, String assessmentName, String assessmentStart, String assessmentEnd, int courseID) {
